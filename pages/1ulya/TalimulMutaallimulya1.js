const TalimulMutaallimulya1 = () => {
    const app = document.getElementById('app');
    app.innerHTML = `<div class="kelas px-4" data-aos="fade">
    <h1 class="mb-5">- TA'LIMUL MUTAALLIM -</h1>
    <form action="" method="post" id="form" name="form-nilai">
      <input type="hidden" name="mapel" value="Ta'limul Mutaallim">
      ...
      <div class="d-flex justify-content-between">
        <button onclick="ulya1()" class="btn btn-outline-secondary btn-mapel">KEMBALI</button>
        <div class="pisah"></div>
...
// Get Data
  $.ajax({
    ...
    const kelas1 = data.filter(el => el.kelas === 'ulya1')
    var i = 1
  ...
  // Post Data
  const scriptURL = 'https://script.google.com/macros/s/AKfycbzs-9yPIM5OnmFzujKbVY3zIeinSh5GyDc7XGoNCidN8ks6yhNCQwWZYn0XHKEGTaH5Tw/exec'
      ...
      if (result.isConfirmed) {
        ...
        fetch(scriptURL, { method: 'POST', body: new FormData(form)})
          .then(response => {
            ...
            setCookie('TalimulMutaallimulya1', 'sudah', 20)
            ulya1()
          })
          .catch(error => {
            Swal.fire({
