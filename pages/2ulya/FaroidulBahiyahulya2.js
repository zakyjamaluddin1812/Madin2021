const FaroidulBahiyahulya2 = () => {
    const app = document.getElementById('app');
    app.innerHTML = `<div class="kelas px-4" data-aos="fade">
    <h1 class="mb-5">- FAROIDUL BAHIYAH -</h1>
    <form action="" method="post" id="form" name="form-nilai">
      <input type="hidden" name="mapel" value="Faroidul Bahiyah">
      ...
      <div class="d-flex justify-content-between">
        <button onclick="ulya2()" class="btn btn-outline-secondary btn-mapel">KEMBALI</button>
        <div class="pisah"></div>
...
// Get Data
  $.ajax({
    ...
    const kelas1 = data.filter(el => el.kelas === 'ulya2')
    var i = 1
  ...
  // Post Data
  const scriptURL = 'https://script.google.com/macros/s/AKfycby_WVoLywREkIbv8WDqZ50nP7k9neMMVqiZhyh5DEe6pmDy__ch_yk9oVIAsRsLc7SO/exec'
      ...
      if (result.isConfirmed) {
        ...
        fetch(scriptURL, { method: 'POST', body: new FormData(form)})
          .then(response => {
            ...
            setCookie('FaroidulBahiyahulya2', 'sudah', 20)
            ulya2()
          })
          .catch(error => {
            Swal.fire({
