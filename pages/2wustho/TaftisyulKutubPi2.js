const TaftisyulKutubPi2 = () => {
    ...
    <form action="" method="post" id="form" name="form-nilai">
      ...
      <div class="d-flex justify-content-between">
        <button onclick="kelas2()" class="btn btn-outline-secondary btn-mapel">KEMBALI</button>
        <div class="pisah"></div>
...
// Get Data
  $.ajax({
    ...
    const kelas1 = data.filter(el => el.kelas == '2' && el.gender === 'p')
    var i = 1
  ...
  // Post Data
  const scriptURL = 'https://script.google.com/macros/s/AKfycbx8104BFSTCjPZ-lNwkvvvOCIOcpDFrYwH8jODxz2-XQqu0IhDoIsjflKvBdY_8V6oSlA/exec'
      ...
      if (result.isConfirmed) {
        ...
        fetch(scriptURL, { method: 'POST', body: new FormData(form)})
          .then(response => {
            ...
            setCookie('TaftisyulKutubPi2', 'sudah', 20)
            kelas2()
          })
          .catch(error => {
            Swal.fire({
