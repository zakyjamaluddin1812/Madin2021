const AqidatulIslamiyah2 = () => {
    const app = document.getElementById('app');
    app.innerHTML = `<div class="kelas px-4" data-aos="fade">
    <h1 class="mb-5">- AQIDATUL ISLAMIYAH -</h1>
    <form action="" method="post" id="form" name="form-nilai">
      <input type="hidden" name="mapel" value="Aqidatul Islamiyah">
...
// Get Data
  $.ajax({
    ...
    const kelas1 = data.filter(el => el.kelas == '2')
    var i = 1
      ...
      if (result.isConfirmed) {
        ...
        fetch(scriptURL, { method: 'POST', body: new FormData(form)})
          .then(response => {
            ...
            setCookie('AqidatulIslamiyah2', 'sudah', 20)
            kelas2()
          })
          .catch(error => {
            Swal.fire({
