const TaftisyulKutubPi3 = () => {
    ...
    <form action="" method="post" id="form" name="form-nilai">
      ...
      <div class="d-flex justify-content-between">
        <button onclick="kelas3()" class="btn btn-outline-secondary btn-mapel">KEMBALI</button>
        <div class="pisah"></div>
...
// Get Data
  $.ajax({
    ...
    const kelas1 = data.filter(el => el.kelas == '3' && el.gender === 'p')
    var i = 1
  ...
  // Post Data
  const scriptURL = 'https://script.google.com/macros/s/AKfycbwn7HLlZZWcYWXW1aK-2Xik9GGUD1zwOElvRW7kafgNC3qDrg-RxFpq5StFVR1h-718dg/exec'
      ...
      if (result.isConfirmed) {
        ...
        fetch(scriptURL, { method: 'POST', body: new FormData(form)})
          .then(response => {
            ...
            setCookie('TaftisyulKutubPi3', 'sudah', 20)
            kelas3()
          })
          .catch(error => {
            Swal.fire({
